  ...
  return (
    <>
      <section className="bg-[#eaeae2]  py-4 w-full overflow-hidden">
        <div className=" hidden lg:block max-w-8xl mx-auto px-5 py-3 text-center">
          <div className="grid grid-cols-5 items-center justify-center gap-10">
            <div className="flex flex-col items-center">
              <h4 className="font-bold mb-6 text-[20px] uppercase">
                Information
              </h4>
              <ul className="space-y-4 text-[14px] text-center font-medium">
                <li>
                  <Link href="/about" className="nav-link hover:text-[#ae3f4f]">
                    About us
                  </Link>
                </li>
                <li>
                  <Link
                    href="/privacy"
                    className="nav-link hover:text-[#ae3f4f]"
                  >
                    Privacy Policy
                  </Link>
                </li>
                ...
                <li>
                  <Link href="/terms" className="nav-link hover:text-[#ae3f4f]">
                    Terms & Conditions
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex flex-col items-center  ">
              <img src="/logo (1).webp" alt="" className="mb-8 h-6.5" />
              <ul className="space-y-2 text-[14px] text-center font-medium">
                <div>T : + (08) 9055 0269</div>
                <div>E:example@example.com</div>
                <li>
                  <a href="/return" className="leading-relaxed">
                    50 Porana Place, West <br /> Casuarinas, <br /> Western
                    Australia,
                    <br />
                    Australia.
                  </a>
            ...
            <div className="flex flex-col items-center ">
              <h4 className="font-bold mb-6 text-[20px] uppercase">support</h4>
              <ul className="space-y-4 text-[14px] text-center font-medium">
                <li>
                  <Link href="/about" className="nav-link hover:text-[#ae3f4f]">
                    Contact Us
        ...
        {/*mobile and tablet views footer*/}
        <section className="bg-[#eaeae2] py-4  ">
          <div className="max-w-6xl px-5 py-3 text-start  md:px-20 sm:px-10 grid grid-cols-1 gap-4 lg:hidden ">
            {" "}
            <div>
              <Accordion
              ...
              >
                <AccordionSummary
                  expandIcon={
                    expanded === "panel1" ? (
                      <RemoveIcon className="text-[#000000]" />
                    ) : (
                      <AddIcon className="text-[#000000]" />
                    )
                  }
            ...
            <div className="flex flex-col items-start my-5 mx-5 ">
              <img src="/logo (1).webp" alt="" className="mb-6 h-6.5" />
              <ul className="space-y-2 text-[14px] text-start font-medium">
                <div>T : + (08) 9055 0269</div>
                <div>E:example@example.com</div>
                <li>
                  <a href="/return" className="leading-relaxed">
                    50 Porana Place, West Casuarinas, <br /> Western Australia,
                    Australia.
                  </a>
                </li>
              </ul>
